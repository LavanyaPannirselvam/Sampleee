...
public class LibrarianHandler{
    private final LibrarianOperations obj = HandlerFactory.getLibrarianHandlerObject();//todo
    ...
    public String addBook(ArrayList<Object> values){
        return obj.addBook(new Book(values.get(0).toString(),values.get(1).toString(),values.get(2).toString(),true,(BookGenre) values.get(3)));
    }
